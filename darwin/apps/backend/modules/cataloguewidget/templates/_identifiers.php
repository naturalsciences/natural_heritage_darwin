...
<table class="catalogue_table">
  ...
  <tr>
    <td>
	  ...
	  href="<?php echo url_for('identifier/identifier?table='.$table.'&cid='.$identifier->getId().'&id='.$eid); ?>">
...
<br />
<?php echo image_tag('add_green.png');?><a title="<?php echo __('Add Identifier');?>" class="link_catalogue" href="<?php echo url_for('identifier/identifier?table='.$table.'&id='.$eid);?>"><?php echo __('Add');?></a>