              ...
              <td><?php echo (isset($comments[$igs->getId()])? $comments[$igs->getId()] : '&nbsp;')  ?></td>              
				...
				<?php if(!$is_choose): ?>	
				  ...
				  <td class="rurl_container">
				   ...
				   <td><!--ftheeten 2018 04 10-->
						<?php echo link_to(__('Scientific names'),'taxonomy/index?ig_num='.$igs->getIgNum(), array("target"=>"_blank"));?>
				   </td>
					<td><!--ftheeten 2018 04 10-->
						<?php echo link_to(__('Localities'),'gtu/index?ig_num='.$igs->getIgNum(), array("target"=>"_blank"));?>
				   </td>
				   <td><!--ftheeten 2018 04 10-->
						<?php echo link_to(__('People'),'people/index?ig_num='.$igs->getIgNum(), array("target"=>"_blank"));?>
				   </td>
				   <?php if($sf_user->isAtLeast(Users::ENCODER)):?>
