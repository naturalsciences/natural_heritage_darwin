...
<?php echo form_tag('identifier/identifier?table='.$sf_params->get('table') . ($form->getObject()->isNew() ?  '&id='.$sf_params->get('id'): '&cid='.$form->getObject()->getId()), array('class'=>'edition qtiped_form', 'id' => 'identifier_form'));?>
<table>
  <tbody>
    <tr>
        <td colspan="2">
