...
<br/>
<div class='download_link' style="display:none"> <a class="bt_close" href="<?php echo url_for( 'taxonomy/downloadTaxonomyFile?taxon_ref='.$taxon_ref);?>"><?php echo __("Download") ?></a></div>
</div>
<script>
...
function get_page()
{
	...
	$.getJSON("<?php print(url_for("taxonomy/testReportRunning")); ?>", {taxon_ref : taxon_ref}, 
	function( data ) {
