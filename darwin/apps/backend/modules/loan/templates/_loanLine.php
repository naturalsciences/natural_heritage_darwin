...
<script type="text/javascript">
  $(document).ready(function () {
	...
	<!--franck php8 replaces  array_key_exists("specimen_ref", $form) -->
    <?php if(!$lineObj->isNew()  &&  $form->offsetExists("specimen_ref") ):?>
		...
		// storage parts------------------------------------------
		var nbrres = "<?php $query = 'SELECT * FROM specimens WHERE id ='.$form['specimen_ref']->getValue().' ORDER BY id';
