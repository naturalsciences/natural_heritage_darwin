...
<tr>
<td>Do you want to copy the properties the original specimen?</td><td>Yes:<input type="radio" name="copy_properties" value="yes" checked="checked"></td><td>No:<input type="radio" name="copy_properties" value="no"></td>
</tr>
</table>
