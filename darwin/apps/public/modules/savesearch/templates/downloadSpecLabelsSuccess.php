...
<br/>
<div class='download_link' style="display:none"> <a class="bt_close" href="<?php echo url_for( 'savesearch/downloadLabelFile?query_id='.$query_id);?>"><?php echo __("Download") ?></a></div>
</div>
<script>
