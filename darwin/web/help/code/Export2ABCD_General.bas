...
'Dim boxStorage, tubeStorage, commonName,
...
If CheckHeaders(check:=False) Then
    ...
    If CopySheetsForRework Then
        ...
        Set node = dom.createComment("Schema ABCD - Template général d'encodage pour les données de collection, version 01/2014)")
        dom.appendChild node
        Set node = Nothing
...
'    strTube = Application.Sheets("cSPECIMEN").Cells(rowCounter, Sheets("cSPECIMEN").Rows(1).Find(tubeStorage, lookAt:=xlWhole).Column)
    ...
    Or strSubcontainerStorage <> "" Or strBarcode <> "" Or strAdditionalID <> "" Or strCode <> "" Then
    
    'Or strBox <> "" Or strTube <> "" _
...
SpecHeadings = Array("specimenID", "additionalID", "code", "accessionNumber", "datasetName", "isPhysical", "acquisitionType", "acquiredFrom", "acquisitionDay", _
"acquisitionMonth", "acquisitionYear", "ocean", "continent", "sea", "country", "state_territory", "province", "region", "archipelago", "district", "county", _
"department", "island", "city", "municipality", "populatedPlace", "naturalSite", "exactSite", _
"samplingCode", "elevationInMeters", "depthInMeters", "latitude", "longitude", "samplingMethod", "fixation", "ecology", _
"siteProperty_1", "sitePropertyValue_1", "siteProperty_2", "sitePropertyValue_2", "siteProperty_3", "sitePropertyValue_3", _
"siteProperty_4", "sitePropertyValue_4", "siteProperty_5", "sitePropertyValue_5", "siteProperty_6", "sitePropertyValue_6", _
...
"specimenPropertyValue_3", "specimenProperty_4", "specimenPropertyValue_4", "specimenProperty_5", "specimenPropertyValue_5", "specimenProperty_6", _
"specimenPropertyValue_6", "specimenProperty_7", "specimenPropertyValue_7", "specimenProperty_8", "specimenPropertyValue_8", "specimenProperty_9", _
"specimenPropertyValue_9", "specimenProperty_10", "specimenPropertyValue_10", "specimenProperty_11", "specimenPropertyValue_11", "specimenProperty_12", _
...
"specimenPropertyValue_18", "specimenProperty_19", "specimenPropertyValue_19", "specimenProperty_20", "specimenPropertyValue_20", "associatedUnitInstitution", _
"associatedUnitCollection", "associatedUnitID", "associationType", "institutionStorage", "buildingStorage", "floorStorage", "roomStorage", "laneStorage", _
"columnStorage", "shelfStorage", "container", "containerType", "containerStorage", "subcontainer", "subcontainerType", "subcontainerStorage", "barcode", "conservation", "notes")

'"boxStorage", "tubeStorage", _
...
'Check if there are duplicates in the column IDs of the SPECIMEN-sheet
'--------------------------------------------------------------------------------------------------
Public Sub CheckDuplicatedID()
    ...
    If errspec > 0 Then
        MsgBox "Some IDs have duplicates. Check the specimenID column in the SPECIMEN-sheet. Duplicates are highlighted in red." & _
        "Number of duplicated ID's: " & errspec
