<?php
class DarwinLdap extends ldapAuth
{
	private $ds;
    private $base_user;
  ...
  public function authenticate($login, $password)
  {
    ...
    // Search the user  
	//ftheeten 2025 12 08 (several BaseUsers)
	$sr=null;
	$conn_loop=false;
	if(is_array($this->base_user))
	{
		foreach($this->base_user as $bu)
		{
			$sr = ldap_search($this->ds, $bu, $this->id_attr."=$login");
