...
class darwinDoImportPropertiesTask extends sfBaseTask
{
	protected function configure()
  {
    ...
    $this->name             = 'do-import-properties';
    $this->briefDescription = 'Store checked codes into the database ';
 ...
 protected function execute($arguments = array(), $options = array())
  {
	...
	{	
		...
		if($import->getFormat()=="properties")
		{
			...
			try 
			{
				$conn->execute("SELECT darwin2.fct_rmca_imp_manager_create_property(staging_properties.*)
					FROM staging_properties where import_ref=?;",[$import_id]);
