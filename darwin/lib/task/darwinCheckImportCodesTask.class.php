...
class darwinCheckImportCodesTask extends sfBaseTask
{
  ...
  protected function configure()
  {
    ...
    $this->name             = 'check-import-codes';
    $this->briefDescription = 'find associations between imported codes and specimens ';
  ...
  protected function execute($arguments = array(), $options = array())
  {
	...
	{	
		...
		if($import->getFormat()=="codes")
		{
			...
			try 
			{
				$conn->execute("select fct_rmca_import_check_codes_launch(?)",[$import_id]);
