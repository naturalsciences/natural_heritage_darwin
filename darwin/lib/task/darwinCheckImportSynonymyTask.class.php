...
class darwinCheckImportSynonymyTask extends sfBaseTask
{
  ...
  protected function configure()
  {
    ...
    $this->name             = 'check-import-synonymy';
    $this->briefDescription = 'find associations between imported synonyms and name ';
