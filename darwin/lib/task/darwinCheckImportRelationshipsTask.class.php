...
class darwinCheckImportRelationshipsTask extends sfBaseTask
{
  ...
  protected function configure()
  {
    ...
    $this->name             = 'check-import-relationships';
    $this->briefDescription = 'find associations between imported relationships and name ';
  ...
  protected function execute($arguments = array(), $options = array())
  {
	...
	{	
		...
		if($import->getFormat()=="relationships")
		{
			...
			try 
			{
				$conn->execute("select fct_rmca_import_check_relationships_launch(?)",[$import_id]);
