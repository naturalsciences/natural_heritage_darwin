...
/**
 * DoctrineTemporalInformationGtuUnnest filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuUnnestFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['from_date_mask'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['from_date_mask'] = new sfValidatorPass(array('required' => false));
    ...
    $this->widgetSchema   ['to_date_mask'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['to_date_mask'] = new sfValidatorPass(array('required' => false));
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'DoctrineTemporalInformationGtuUnnest', 'column' => 'id'));

    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu_unnest_filters[%s]');
  }

  public function getModelName()
  {
    return 'DoctrineTemporalInformationGtuUnnest';
  }
