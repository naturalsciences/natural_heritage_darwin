...
/**
 * DoctrineTemporalInformationGtu filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'DoctrineTemporalInformationGtu', 'column' => 'id'));

    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu_filters[%s]');
  }

  public function getModelName()
  {
    return 'DoctrineTemporalInformationGtu';
  }
