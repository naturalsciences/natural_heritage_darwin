...
/**
 * VSpecimensCommentsText filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseVSpecimensCommentsTextFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['specimen_creation_date'] = new sfWidgetFormFilterInput();
    ...
    $this->widgetSchema   ['ig_main_code_indexed'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['ig_main_code_indexed'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['mids_level'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['mids_level'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['comments_text'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['comments_text'] = new sfValidatorPass(array('required' => false));
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'VSpecimensCommentsText', 'column' => 'id'));
    ...
    $this->widgetSchema->setNameFormat('v_specimens_comments_text_filters[%s]');
  }
