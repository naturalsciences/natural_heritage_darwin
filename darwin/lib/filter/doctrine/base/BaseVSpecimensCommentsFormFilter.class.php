...
/**
 * VSpecimensComments filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseVSpecimensCommentsFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'VSpecimensComments', 'column' => 'id'));
    ...
    $this->widgetSchema->setNameFormat('v_specimens_comments_filters[%s]');
  }
