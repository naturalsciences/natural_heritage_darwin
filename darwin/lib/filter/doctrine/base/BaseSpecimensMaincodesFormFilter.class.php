...
/**
 * SpecimensMaincodes filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseSpecimensMaincodesFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'SpecimensMaincodes', 'column' => 'id'));
