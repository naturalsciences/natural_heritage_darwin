 ...
 * @version    SVN: $Id$
 */
abstract class BaseSpecimensFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['gtu_others_tag_indexed'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['gtu_others_tag_indexed'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['gtu_others_tag_value'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['gtu_others_tag_value'] = new sfValidatorPass(array('required' => false));
    ...
    $this->widgetSchema   ['gtu_iso3166'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['gtu_iso3166'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['gtu_iso3166_subdivision'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['gtu_iso3166_subdivision'] = new sfValidatorPass(array('required' => false));
    ...
    $this->widgetSchema   ['specimen_count_males_min'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_males_min'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['specimen_count_males_max'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_males_max'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['specimen_count_females_min'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_females_min'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['specimen_count_females_max'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_females_max'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['specimen_count_juveniles_min'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_juveniles_min'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));

    $this->widgetSchema   ['specimen_count_juveniles_max'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['specimen_count_juveniles_max'] = new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false)));
    ...
    $this->widgetSchema   ['valid_label'] = new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no')));
    $this->validatorSchema['valid_label'] = new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0)));

    $this->widgetSchema   ['label_created_on'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['label_created_on'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['label_created_by'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['label_created_by'] = new sfValidatorPass(array('required' => false));
    ...
    $this->widgetSchema   ['specimen_creation_date'] = new sfWidgetFormFilterInput(array('with_empty' => false));
    $this->validatorSchema['specimen_creation_date'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['collection_name_full_path'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['collection_name_full_path'] = new sfValidatorPass(array('required' => false));
    ...
    $this->validatorSchema['id'] = new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'Specimens', 'column' => 'id'));
  ...
  public function getFields()
  {
    return array_merge(parent::getFields(), array(
      ...
      'collection_name_full_path' => 'Text',
      'collection_ref' => 'ForeignKey',
      'expedition_ref' => 'ForeignKey',
      'gtu_ref' => 'ForeignKey',
      'taxon_ref' => 'ForeignKey',
