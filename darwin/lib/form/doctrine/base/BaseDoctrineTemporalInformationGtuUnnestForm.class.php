...
/**
 * DoctrineTemporalInformationGtuUnnest form base class.
 *
 * @method DoctrineTemporalInformationGtuUnnest getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuUnnestForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['from_date_mask'] = new sfWidgetFormTextarea();
    $this->validatorSchema['from_date_mask'] = new sfValidatorString(array('required' => false));
    ...
    $this->widgetSchema   ['to_date_mask'] = new sfWidgetFormTextarea();
    $this->validatorSchema['to_date_mask'] = new sfValidatorString(array('required' => false));
    ...
    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu_unnest[%s]');
  }
