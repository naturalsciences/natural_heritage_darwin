...
/**
 * TvReportingCountAllSpecimensByCollectionYearIg form base class.
 *
 * @method TvReportingCountAllSpecimensByCollectionYearIg getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 */
abstract class BaseTvReportingCountAllSpecimensByCollectionYearIgForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tv_reporting_count_all_specimens_by_collection_year_ig[%s]');
