...
/**
 * DoctrineTemporalInformationGtu form base class.
 *
 * @method DoctrineTemporalInformationGtu getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu[%s]');
  }
