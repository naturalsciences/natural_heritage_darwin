...
abstract class BaseGtuForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['elevation_unit'] = new sfWidgetFormTextarea();
    $this->validatorSchema['elevation_unit'] = new sfValidatorString(array('required' => false));
    ...
    $this->widgetSchema   ['wkt_str'] = new sfWidgetFormTextarea();
    $this->validatorSchema['wkt_str'] = new sfValidatorString(array('required' => false));
