...
/**
 * VSpecimensCommentsText form base class.
 *
 * @method VSpecimensCommentsText getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseVSpecimensCommentsTextForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->validatorSchema['specimen_creation_date'] = new sfValidatorString(array('required' => false));
    ...
    $this->widgetSchema   ['mids_level'] = new sfWidgetFormInputText();
    $this->validatorSchema['mids_level'] = new sfValidatorInteger(array('required' => false));

    $this->widgetSchema   ['comments_text'] = new sfWidgetFormTextarea();
    $this->validatorSchema['comments_text'] = new sfValidatorString(array('required' => false));
    ...
    $this->widgetSchema->setNameFormat('v_specimens_comments_text[%s]');
  }
