...
abstract class BaseImportsForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['history_taxonomy'] = new sfWidgetFormTextarea();
    $this->validatorSchema['history_taxonomy'] = new sfValidatorString(array('required' => false));

    $this->widgetSchema   ['collection_ref_for_gtu'] = new sfWidgetFormInputText();
    $this->validatorSchema['collection_ref_for_gtu'] = new sfValidatorInteger();
