...
/**
 * DoctrineTemporalInformationGtuGroupUnnestTags form base class.
 *
 * @method DoctrineTemporalInformationGtuGroupUnnestTags getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuGroupUnnestTagsForm extends DarwinModelForm
{
