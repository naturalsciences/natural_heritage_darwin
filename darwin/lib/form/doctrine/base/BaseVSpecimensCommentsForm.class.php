...
/**
 * VSpecimensComments form base class.
 *
 * @method VSpecimensComments getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseVSpecimensCommentsForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('v_specimens_comments[%s]');
  }
