...
/**
 * Georef form base class.
 *
 * @method Georef getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseGeorefForm extends DarwinModelForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('georef[%s]');
  }
