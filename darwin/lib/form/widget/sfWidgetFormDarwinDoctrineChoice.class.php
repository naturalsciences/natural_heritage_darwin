 ...
 */
class sfWidgetFormDarwinDoctrineChoice extends sfWidgetFormDoctrineChoice
{
  /**
   * @see sfWidget
   */
 ...
 */
 private function callTableMethod()
 {
   ...
   {
     $results = call_user_func_array(array(Doctrine_Core::getTable($this->getOption('model')),
                                           $tableMethod['method']
                                          ),
