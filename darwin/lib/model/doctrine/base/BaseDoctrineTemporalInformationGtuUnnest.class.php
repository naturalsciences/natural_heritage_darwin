...
/**
 * BaseDoctrineTemporalInformationGtuUnnest
 * 
 ...
 * @property string $from_date_mask
 * @property string $from_date
 * @property string $to_date_mask
 ...
 * @method string                               getFromDateMask()            Returns the current record's "from_date_mask" value
 * @method string                               getFromDate()                Returns the current record's "from_date" value
 * @method string                               getToDateMask()              Returns the current record's "to_date_mask" value
 ...
 * @method DoctrineTemporalInformationGtuUnnest setId()                      Sets the current record's "id" value
 * @method DoctrineTemporalInformationGtuUnnest setCode()                    Sets the current record's "code" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuFromDateMask()         Sets the current record's "gtu_from_date_mask" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuFromDate()             Sets the current record's "gtu_from_date" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuToDateMask()           Sets the current record's "gtu_to_date_mask" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuToDate()               Sets the current record's "gtu_to_date" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitude()                Sets the current record's "latitude" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitude()               Sets the current record's "longitude" value
 * @method DoctrineTemporalInformationGtuUnnest setLocation()                Sets the current record's "location" value
 * @method DoctrineTemporalInformationGtuUnnest setLatLongAccuracy()         Sets the current record's "lat_long_accuracy" value
 * @method DoctrineTemporalInformationGtuUnnest setElevation()               Sets the current record's "elevation" value
 * @method DoctrineTemporalInformationGtuUnnest setElevationAccuracy()       Sets the current record's "elevation_accuracy" value
 * @method DoctrineTemporalInformationGtuUnnest setImportRef()               Sets the current record's "import_ref" value
 * @method DoctrineTemporalInformationGtuUnnest setCollectorRefs()           Sets the current record's "collector_refs" value
 * @method DoctrineTemporalInformationGtuUnnest setExpeditionRefs()          Sets the current record's "expedition_refs" value
 * @method DoctrineTemporalInformationGtuUnnest setCollectionRef()           Sets the current record's "collection_ref" value
 * @method DoctrineTemporalInformationGtuUnnest setCoordinatesSource()       Sets the current record's "coordinates_source" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitudeDmsDegree()       Sets the current record's "latitude_dms_degree" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitudeDmsMinutes()      Sets the current record's "latitude_dms_minutes" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitudeDmsSeconds()      Sets the current record's "latitude_dms_seconds" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitudeDmsDirection()    Sets the current record's "latitude_dms_direction" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitudeDmsDegree()      Sets the current record's "longitude_dms_degree" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitudeDmsMinutes()     Sets the current record's "longitude_dms_minutes" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitudeDmsSeconds()     Sets the current record's "longitude_dms_seconds" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitudeDmsDirection()   Sets the current record's "longitude_dms_direction" value
 * @method DoctrineTemporalInformationGtuUnnest setLatitudeUtm()             Sets the current record's "latitude_utm" value
 * @method DoctrineTemporalInformationGtuUnnest setLongitudeUtm()            Sets the current record's "longitude_utm" value
 * @method DoctrineTemporalInformationGtuUnnest setUtmZone()                 Sets the current record's "utm_zone" value
 * @method DoctrineTemporalInformationGtuUnnest setFromDateMask()            Sets the current record's "from_date_mask" value
 * @method DoctrineTemporalInformationGtuUnnest setFromDate()                Sets the current record's "from_date" value
 * @method DoctrineTemporalInformationGtuUnnest setToDateMask()              Sets the current record's "to_date_mask" value
 * @method DoctrineTemporalInformationGtuUnnest setToDate()                  Sets the current record's "to_date" value
 * @method DoctrineTemporalInformationGtuUnnest setTags()                    Sets the current record's "Tags" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuComments()             Sets the current record's "GtuComments" value
 * @method DoctrineTemporalInformationGtuUnnest setGtuProperties()           Sets the current record's "GtuProperties" value
 * @method DoctrineTemporalInformationGtuUnnest setTagGroups()               Sets the current record's "TagGroups" collection
 * 
 * @package    darwin
 * @subpackage model
 ...
 */
abstract class BaseDoctrineTemporalInformationGtuUnnest extends DarwinModel
{
    public function setTableDefinition()
    {
        $this->setTableName('doctrine_temporal_information_gtu_unnest');
        ...
        $this->hasColumn('from_date_mask', 'string', null, array(
             'type' => 'string',
             ));
        $this->hasColumn('from_date', 'string', null, array(
             'type' => 'string',
             ));
        $this->hasColumn('to_date_mask', 'string', null, array(
             'type' => 'string',
             ));
