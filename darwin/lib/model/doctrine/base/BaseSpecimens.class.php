 ...
 * @method Specimens                        setStagingProperties()                 Sets the current record's "StagingProperties" collection
 * @method Specimens                        setStagingCodes()                      Sets the current record's "StagingCodes" collection
 * @method Specimens                        setStagingUpdateSpecimenRelationship() Sets the current record's "StagingUpdateSpecimenRelationship" collection
...
abstract class BaseSpecimens extends DarwinModel
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('TaxonomicIdentifications', array(
             'local' => 'id',
             'foreign' => 'record_id'));
