 ...
 * @method Tags                                          setDoctrineTemporalInformationGtuGroupUnnest()     Sets the current record's "DoctrineTemporalInformationGtuGroupUnnest" value
 * @method Tags                                          setDoctrineTemporalInformationGtuGroupTags()       Sets the current record's "DoctrineTemporalInformationGtuGroupTags" value
 * @method Tags                                          setDoctrineTemporalInformationGtuGroupUnnestTags() Sets the current record's "DoctrineTemporalInformationGtuGroupUnnestTags" value
