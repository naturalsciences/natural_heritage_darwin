...
if(isset($timestamp)):
?>
    <?php echo form_tag('property/add?table='.$sf_params->get('table').'&id='.$sf_params->get('id')."&timestamp=".$timestamp.($form->getObject()->isNew() ? '': '&rid='.$form->getObject()->getId() ), array('class'=>'edition qtiped_form', 'id'=>'property_form'));?>
<?php else: ?>
