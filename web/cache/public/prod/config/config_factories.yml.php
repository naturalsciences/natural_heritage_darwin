...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'notice',
  'file' => '/var/www/web/log/public_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/web/cache/public/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/web/apps/public/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('darwin2'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/web/cache/public/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/web/apps/public/template',
)));
