...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'notice',
  'file' => '/var/git_ftheeten/web/log/public_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/git_ftheeten/web/cache/public/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/git_ftheeten/web/apps/public/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('darwin2'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/git_ftheeten/web/cache/public/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/git_ftheeten/web/apps/public/template',
)));
