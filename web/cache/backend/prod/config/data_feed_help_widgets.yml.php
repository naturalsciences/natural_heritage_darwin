...
sfConfig::add(array(
  ...
  'informativeWorkflow' => 'This widget allows you to add a note for this specific catalogue, this note can be a modification suggestion, an asking for checking to managers, a checking, an explanation when a modification is added. The number of options in the status field depends on your privileges',
  'biblio' => 'This widget allows you to add a bibliographic reference of the item',
  'relatedFiles' => 'This widget allows you to add a file related to the item - This can either be a document describing the item or an illustration of it.',
),
  'widget_peoplewidget' => array (
  'comment' => 'This widget is used to add commentary.If you wish, You can add more than one commentary notion per record. You cannot add the same notion twice in one record, however',
  ...
  'extLinks' => 'This widget allows you to add a URL address to the record (ex : http://www.naturalsciences.be)',
  'informativeWorkflow' => 'This widget allows you to add a note for this specific people, this note can be a modification suggestion, a question destined to managers, an own note to remind you of something, an explanation when a modification is added. The number of options in the status field depends on your privileges',
  'biblio' => 'This widget allows you to add a bibliographic reference of the item',
  'relatedFiles' => 'This widget allows you to add a file related to the item - This can either be a document describing the item or an illustration of it.',
),
  'widget_specimensearchwidget' => array (
  ...
  'part' => 'Search over part type and name of a part',
  'multimedia' => 'If you\'re looking for only illustrated object (or object with files), check the box below',
  'comments' => 'Via this widget you can perform a search in comments linked to specimens. You can also use the dedicated comment search.',
  'properties' => 'Via this widget you can perform a search in properties linked to specimens. You can also use the dedicated propety search. Look for 1 specific value using the "from" field or a range using "from" and "to".',
  'storageParts' => 'Via this widget you can perform a search in the storage (fality) and institutions hosting the specimens.',
),
  'widget_specimenwidget' => array (
  ...
  'specimensRelationships' => 'This widget allows you to add some relation to another elements. In the first case, you could add a biological type of element. E.g Imagine that you have a shell that is covered by a colony of moss animals. You could add the Taxonomic name Membranipora tenuis Desor, 1848 in the widget and you could also specify the amount() of the area covered by the colony. In a second case, you could describe the different elements that constitute the whole mineral that you are encoding. E.g. your rock is made up by two mineralogic elements, one being 95% quartz and the second 5% calcite.',
  ...
  'informativeWorkflow' => 'This widget allows you to add a note for this specific specimen, this note can be a modification suggestion, a question destined to managers, an own note to remind you of something, an explanation when a modification is added. The number of options in the status field depends on your privileges',
  'biblio' => 'This widget allows you to add a bibliographic reference of the item',
  'refRelatedFiles' => 'This widget allows you to add a file related to the item - This can either be a document describing the item or an illustration of it.',
  'historic' => 'You can see here an historic of who has modified this specimen',
  ...
  'specimenCount' => 'In this widget you can specify the exact number of individuals belonging to the same specimen or you can specify a lower and upperbound estimate of the number of individuals"',
  ...
  'loan' => 'This widget allows you to see if this specimen is currently on loan. If it is, you can see when it has been borrowed and when it due for return.',
  ...
  'ecology' => 'widget for the ecological information (test)',
),
  'widget_userswidget' => array (
  'address' => 'This widget allows you to add one or more addresses, it can be home address, work or more. The locality and the country are required fields',
  ...
  'widget_loanwidget' => array (
  'mainInfo' => 'Insert the name of the loan here, You can also set a description, the beginning and the end date of the loan',
  ...
  'widget_maintenanceswidget' => array (
  'refComments' => 'This widget is used to add commentary.If you wish, You can add more than one commentary notion per record. You cannot add the same notion twice in one record, however',
  'refProperties' => 'This widget allows you to add some more structured commentary, but be sure that your information is entered consistently. You could e.g. add the following: type= watertemperature, sub type= C°,Date from=01/07/1974 10:05:00, value= 15',
  'extLinks' => 'This widget allows you to add a URL address to the record (ex : http://www.naturalsciences.be)',
