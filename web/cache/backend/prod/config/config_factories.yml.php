...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'notice',
  'file' => '/var/git_ftheeten/web/log/backend_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/git_ftheeten/web/cache/backend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/git_ftheeten/web/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('darwin2'),
  ...
  {
    $class = sfConfig::get('sf_factory_view_cache', 'sfAPCCache');
    $cache = new $class(sfConfig::get('sf_factory_view_cache_parameters', array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/git_ftheeten/web/cache/backend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/git_ftheeten/web/apps/backend/template',
)));
