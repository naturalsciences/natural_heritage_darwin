...
/**
 * DoctrineDistinctTemporalInformation filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 */
abstract class BaseDoctrineDistinctTemporalInformationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('doctrine_distinct_temporal_information_filters[%s]');
