...
/**
 * DoctrineTemporalInformationGtuGroupUnnest filter form base class.
 *
 * @package    darwin
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuGroupUnnestFormFilter extends DarwinModelFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu_group_unnest_filters[%s]');
  }

  public function getModelName()
  {
    return 'DoctrineTemporalInformationGtuGroupUnnest';
  }
