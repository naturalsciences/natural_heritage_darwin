...
/**
 * DoctrineTemporalInformationGtuGroupUnnest form base class.
 *
 * @method DoctrineTemporalInformationGtuGroupUnnest getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseDoctrineTemporalInformationGtuGroupUnnestForm extends DarwinModelForm
{
