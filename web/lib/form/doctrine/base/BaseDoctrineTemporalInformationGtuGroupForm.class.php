...
/**
 * DoctrineTemporalInformationGtuGroup form base class.
 *
 * @method DoctrineTemporalInformationGtuGroup getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 */
abstract class BaseDoctrineTemporalInformationGtuGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'array_from_date_mask'    => new sfWidgetFormTextarea(),
      'array_from_date'         => new sfWidgetFormTextarea(),
      'array_to_date_mask'      => new sfWidgetFormTextarea(),
      'array_to_date'           => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'array_from_date_mask'    => new sfValidatorString(array('required' => false)),
      'array_from_date'         => new sfValidatorString(array('required' => false)),
      'array_to_date_mask'      => new sfValidatorString(array('required' => false)),
      'array_to_date'           => new sfValidatorString(array('required' => false)),
      'comments'                => new sfValidatorString(array('required' => false)),
      'properties'              => new sfValidatorString(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('doctrine_temporal_information_gtu_group[%s]');
