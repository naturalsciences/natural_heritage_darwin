...
/**
 * BaseDoctrineTemporalInformationGtuGroupTags
 * 
 ...
 * @method DoctrineTemporalInformationGtuGroupTags setGtuFromDate()             Sets the current record's "gtu_from_date" value
 * @method DoctrineTemporalInformationGtuGroupTags setGtuToDateMask()           Sets the current record's "gtu_to_date_mask" value
 * @method DoctrineTemporalInformationGtuGroupTags setGtuToDate()               Sets the current record's "gtu_to_date" value
 * @method DoctrineTemporalInformationGtuGroupTags setLatitude()                Sets the current record's "latitude" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitude()               Sets the current record's "longitude" value
 * @method DoctrineTemporalInformationGtuGroupTags setLocation()                Sets the current record's "location" value
 * @method DoctrineTemporalInformationGtuGroupTags setLatLongAccuracy()         Sets the current record's "lat_long_accuracy" value
 * @method DoctrineTemporalInformationGtuGroupTags setElevation()               Sets the current record's "elevation" value
 * @method DoctrineTemporalInformationGtuGroupTags setElevationAccuracy()       Sets the current record's "elevation_accuracy" value
 ...
 * @method DoctrineTemporalInformationGtuGroupTags setLatitudeDmsMinutes()      Sets the current record's "latitude_dms_minutes" value
 * @method DoctrineTemporalInformationGtuGroupTags setLatitudeDmsSeconds()      Sets the current record's "latitude_dms_seconds" value
 * @method DoctrineTemporalInformationGtuGroupTags setLatitudeDmsDirection()    Sets the current record's "latitude_dms_direction" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitudeDmsDegree()      Sets the current record's "longitude_dms_degree" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitudeDmsMinutes()     Sets the current record's "longitude_dms_minutes" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitudeDmsSeconds()     Sets the current record's "longitude_dms_seconds" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitudeDmsDirection()   Sets the current record's "longitude_dms_direction" value
 * @method DoctrineTemporalInformationGtuGroupTags setLatitudeUtm()             Sets the current record's "latitude_utm" value
 * @method DoctrineTemporalInformationGtuGroupTags setLongitudeUtm()            Sets the current record's "longitude_utm" value
 * @method DoctrineTemporalInformationGtuGroupTags setUtmZone()                 Sets the current record's "utm_zone" value
 * @method DoctrineTemporalInformationGtuGroupTags setArrayFromDateMask()       Sets the current record's "array_from_date_mask" value
 * @method DoctrineTemporalInformationGtuGroupTags setArrayFromDate()           Sets the current record's "array_from_date" value
 * @method DoctrineTemporalInformationGtuGroupTags setArrayToDateMask()         Sets the current record's "array_to_date_mask" value
 * @method DoctrineTemporalInformationGtuGroupTags setArrayToDate()             Sets the current record's "array_to_date" value
 * @method DoctrineTemporalInformationGtuGroupTags setComments()                Sets the current record's "comments" value
 ...
 */
abstract class BaseDoctrineTemporalInformationGtuGroupTags extends DarwinModel
{
    public function setTableDefinition()
    {
        $this->setTableName('doctrine_temporal_information_gtu_group_tags');
