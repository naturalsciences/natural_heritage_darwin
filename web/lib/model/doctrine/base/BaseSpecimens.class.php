 ...
 * @method Specimens           setGtuOthersTagIndexed()          Sets the current record's "gtu_others_tag_indexed" value
 ...
 * @method Specimens           setValidLabel()                   Sets the current record's "valid_label" value
 * @method Specimens           setLabelCreatedOn()               Sets the current record's "label_created_on" value
...
abstract class BaseSpecimens extends DarwinModel
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('valid_label', 'boolean', null, array(
             'type' => 'boolean',
             ));
        $this->hasColumn('label_created_on', 'string', null, array(
             'type' => 'string',
             ));
