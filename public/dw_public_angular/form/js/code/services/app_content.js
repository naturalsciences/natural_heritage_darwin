...
//very tedious!!!
 ...
 darwinApp.config(function(tmhDynamicLocaleProvider) {
    tmhDynamicLocaleProvider.localeLocationPattern('./dw_public_angular/form/js/code/common/i18n/angular-locale_{{locale}}.js');
...
darwinApp.config(function($translateProvider) {
 ...
 $translateProvider.useSanitizeValueStrategy('escape');
  $translateProvider.translations('en', {
	TITLE_SEARCH_PAGE: 'Darwin public search interface | RMCA',
    ...
    nl: 'Nederlands',
    fr: 'Français',
    COLLECTION_SEARCH_ichtyology: 'Ichtyological database of the RMCA',
    COLLECTION_SEARCH_mammalogy: 'Mammal database of the RMCA',
    COLLECTION_SEARCH_coelentera: 'Coelenterata database of the RMCA',
    COLLECTION_SEARCH_arachnomorphae: 'Arachnomorphae database of the RMCA',
  ...
  .translations('fr', {
	TITLE_SEARCH_PAGE: 'Darwin public interface de recherche | MRAC',
    ...
    nl: 'Nederlands',
    fr: 'Français',
    COLLECTION_SEARCH_ichtyology: 'Base de données ichtyologiques du MRAC',
    COLLECTION_SEARCH_mammalogy: 'Base de données mammalogiques du MRAC',
    COLLECTION_SEARCH_coelentera: 'Base de données des cœlentérés du MRAC',
    COLLECTION_SEARCH_arachnomorphae: 'Base de données des arachnidés du MRAC',
    CONTACT_PERSON: 'Contact',
	SEX: 'Sexe',
	...
	RMCA : 'Musée royal de l’Afrique centrale',
  ...
  .translations('nl', {
	TITLE_SEARCH_PAGE: 'Darwin public zoekinterface | KMMA',
    ...
    nl: 'Nederlands',
    fr: 'Français',
    COLLECTION_SEARCH_ichtyology: 'Ichtyologische databank van het KMMA',
    COLLECTION_SEARCH_mammalogy: 'Databank van zoogdieren van het KMMA',
    COLLECTION_SEARCH_coelentera: 'Databank van coelenterata van het KMMA', 
    COLLECTION_SEARCH_arachnomorphae: 'Archnida databank van het KMMA',
	...
	RMCA : 'Koninklijk Museum voor Midden-Afrika',
...
darwinApp.factory("DarwinFactory", ['$http', function($http){  
    ...
    obj.getTypes=function(collection_id)
    {
     ...
     obj.getSpecimen=function(num)
     {
			
            var urlTmp='./dw_public_angular/ws/ws.php?operation=get_specimen&uuid='+num;
			//console.log(urlTmp);
