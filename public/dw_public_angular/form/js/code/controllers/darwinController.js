...
//END Date
  ...
  $scope.getData = function(collection, taxas, spec_nr, ig_num, countries, localities, collectors, coll_date_begin, coll_date_end, types, p_has_images, p_has_3d, north, south, west, east, wkt, p_georef_only, p_citizen_sciences) 
  {
	console.log("IG_NUMS");
	console.log(ig_num);
	 ...
	 var urlTmp= $scope.url_prefix +'operation=search_specimen&collections='+collection+'&taxas='+taxas+'&number='+spec_nr+'&ig_num='+ig_num+'&countries='+countries+'&localities='+localities+'&collectors='+collectors+'&gathering_begin='+coll_date_begin+'&gathering_end='+coll_date_end+'&types='+types+'&has_images='+p_has_images+'&has_3d='+p_has_3d+'&north='+north+'&south='+south+'&west='+west+'&east='+east+'&wkt='+wkt+"&georef_only="+p_georef_only+"&citizen_sciences="+p_citizen_sciences;
	   ...
	   //var urlTmpGeoRef= $scope.url_prefix +'operation=count_georef_specimen&collections='+collection+'&taxas='+taxas+'&number='+spec_nr+'&ig_num='+ig_num+'&countries='+countries+'&localities='+localities+'&collectors='+collectors+'&gathering_begin='+coll_date_begin+'&gathering_end='+coll_date_end+'&types='+types+'&has_images='+p_has_images+'&has_3d='+p_has_3d+'&north='+north+'&south='+south+'&west='+west+'&east='+east+'&wkt='+wkt+"&georef_only="+p_georef_only+"&citizen_sciences="+p_citizen_sciences;
