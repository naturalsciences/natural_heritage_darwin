...
/**
 * ZzzRotiferSpecimens form base class.
 *
 * @method ZzzRotiferSpecimens getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 */
abstract class BaseZzzRotiferSpecimensForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'spec_ident_ids'           => new sfWidgetFormInputText(),
      'spec_coll_ids'            => new sfWidgetFormInputText(),
      'spec_don_sel_ids'         => new sfWidgetFormInputText(),
      ...
      'gtu_province_tag_value'   => new sfWidgetFormTextarea(),
      'gtu_province_tag_indexed' => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'gtu_province_tag_value'   => new sfValidatorString(array('required' => false)),
      'gtu_province_tag_indexed' => new sfValidatorString(array('required' => false)),
      ...
      'ig_date'                  => new sfValidatorDate(array('required' => false)),
      'col'                      => new sfValidatorString(array('required' => false)),
      'gtu_location'             => new sfValidatorString(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('zzz_rotifer_specimens[%s]');
