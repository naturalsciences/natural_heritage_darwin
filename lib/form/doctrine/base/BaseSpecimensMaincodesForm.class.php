...
/**
 * SpecimensMaincodes form base class.
 *
 * @method SpecimensMaincodes getObject() Returns the current form's model object
 *
 * @package    darwin
 * @subpackage form
 ...
 */
abstract class BaseSpecimensMaincodesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                      => new sfWidgetFormInputHidden(),
      'code_main'               => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'code_main'               => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('specimens_maincodes[%s]');
